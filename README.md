...
These are my instructions on how to setup a home-made k8s cluster, at home (maybe recycling some old PC).

# Chapters

1. The Cluster [TalosOS](01.talos/README.md)
2. The ingress-controller [traefik](02.ingress-controller/README.md)
